    ...
    dynamic:
      datasource:
        ...
        slave:
          username: root
          password: root
          url: jdbc:mysql://127.0.0.1:3306/test1?useUnicode=true&characterEncoding=UTF-8&useSSL=false&autoReconnect=true&failOverReadOnly=false&serverTimezone=GMT%2B8
          driver-class-name: com.mysql.jdbc.Driver
```
