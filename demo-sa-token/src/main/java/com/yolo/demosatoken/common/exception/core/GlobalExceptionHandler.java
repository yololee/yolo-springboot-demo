package com.yolo.demosatoken.common.exception.core;
...
import com.yolo.demosatoken.common.exception.ParamException;
...
public class GlobalExceptionHandler {
    ...
    public ApiResponse loginExceptionHandler(NotLoginException e) {
        return ApiResponse.ofException(ApiStatus.PARAM_ERROR,e.getLocalizedMessage());
    }
    ...
    public ApiResponse notExceptionHandler(NotRoleException e) {
        return ApiResponse.ofException(ApiStatus.FORBIDDEN,e.getLocalizedMessage());
    }
