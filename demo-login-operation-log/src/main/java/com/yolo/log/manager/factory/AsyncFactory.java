    ...
    public static TimerTask recordOperation(final SysOperLog operationLog) {
        return new TimerTask() {
            ...
            public void run() {
                ...
                SpringBeanUtils.getBean(SysOperLogMapper.class).insertOperlog(operationLog);
            }
        };
    }
    ...
    public static TimerTask recordLoginInfo(final String username, final String status, final String message, final Object... args) {
        ...
        return new TimerTask() {
            ...
            public void run() {
                ...
                // 插入数据
                SpringBeanUtils.getBean(SysLoginInfoMapper.class).insertLoginInfo(loginInfo);
            }
        };
    }
}
