package com.yolo.demo.common.dto;
...
public class ApiResponse {
    ...
    public static  ApiResponse ofException(Integer code, String message) {
        return new ApiResponse(code, message);
    }

    public static  ApiResponse ofException(String message) {
        return new ApiResponse(ApiStatus.PARAM_ERROR.getCode(), message);
    }
