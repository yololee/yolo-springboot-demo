...
我们写的这个Filter过滤类, 目的就是为了将原生的`HttpServletRequest`, 包装成我们自己的`XssRequest`,这样我们在web层获取参数的时候,都是从包装的reqeust中获取加工后的参数
...
`Whitelist.relaxed()`是指标签的白名单, 在这个白名单外的其他标签将会被替换为空字符串

除了`Whitelist.relaxed()`,还有下面几种预设的可以选择

[Whitelist官网介绍](https://jsoup.org/apidocs/org/jsoup/safety/Safelist.html)
...
![image-20230612154107612](https://gitee.com/huanglei1111/phone-md/raw/master/images/image-20230612154107612.png)

集成之后的

![image-20230612154326595](https://gitee.com/huanglei1111/phone-md/raw/master/images/image-20230612154326595.png)
